...
1. Check that there isn't already an issue about your idea in the [qbic-pipelines/rnadeseq issues](https://github.com/qbic-pipelinesrnadeseq/issues) to avoid duplicating work
...
To make the qbic-pipelines/rnadeseq code and processing logic more understandable for new contributors and to ensure quality, we semi-standardise the way the code and other contributions are written.
