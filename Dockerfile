...
ENV PATH /opt/conda/envs/qbic-pipelines-rnadeseq-1.2.0/bin:$PATH

# Dump the details of the installed packates to a file for posterity
RUN conda env export --name qbic-pipelines-rnadeseq-1.2.0 > qbic-pipelines-rnadeseq-1.2.0.yml
