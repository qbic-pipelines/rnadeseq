...
ENV PATH /opt/conda/envs/qbic-pipelines-rnadeseq-1.2.0dev/bin:$PATH

# Dump the details of the installed packates to a file for posterity
RUN conda env export --name qbic-pipelines-rnadeseq-1.2.0dev > qbic-pipelines-rnadeseq-1.2.0dev.yml
