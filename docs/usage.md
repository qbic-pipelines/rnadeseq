...
Configuration file describing the sections that need to be present in the report, text can also be specified that is desired 
to be added to the outlook section.
