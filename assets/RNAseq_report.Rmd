...
if (params$input_type %in% c("rsem", "salmon") & isNot(params$gtf)){
...
path_norm_counts <- paste0('differential_gene_expression/gene_counts_tables/', ifelse(params$rlog, 'rlog_transformed_gene_counts.tsv', 'vst_transformed_gene_counts.tsv'))
...
library(formattable)
#TODO: Make multiqc optional -->check if it actually still works at all; where does the file come from?
