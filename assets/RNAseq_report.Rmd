...
```{r, out.width="100%", out.height="100%"}
  ...
  pg %>% layout(margin = list(l = 100, b=100), width=500, height = 1000)
```
...
```{r, eval=report_options$KEGG, out.height = "100%", out.width = "100%", warning = FALSE}
  library(gprofiler2)
  #library(rlist)
  ...
  if (nrow(path_enrich) > 0){
    ...
    pg2 %>% layout(margin = list(l = 75, b = 100), width=500, height = 1000)
  }
