...
database_string <- substring(database_string, 1, nchar(database_string)-1)
cat(paste("For pathway analysis, the R packages `gprofiler2 v",version_gprofiler2,"`, `AnnotationDbi v", version_annotation, "` and `", name_species, " v", version_annotation, "` were employed. Also, the following databases were queried:", database_string, sep=''))
```
