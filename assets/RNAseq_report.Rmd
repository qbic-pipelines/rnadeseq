...
The Nextflow-based nf-core pipeline `rnaseq ", as.character(ifelse(is_csv, version["nf-core/rnaseq"], version["Workflow"][[1]]["nf-core/rnaseq"])),
"` [^1] was used for the RNAseq Bioinfomatics analysis. `FASTQC ",
as.character(ifelse(is_csv, version["FastQC"], version["FASTQC"][[1]]["fastqc"])),
...
as.character(ifelse(is_csv, version["Trim Galore!"], version["TRIMGALORE"][[1]]["trimgalore"])),
"` [^4] [@krueger2012trim]. `STAR v",
as.character(ifelse(is_csv, substring((version["STAR"]), 7, ), version["MAKE_TRANSCRIPTS_FASTA"][[1]]["star"])),
...
as.character(ifelse(is_csv, version["RSeQC"], version["RSEQC_BAMSTAT"][[1]]["rseqc"])),
...
```{r MQC_cite, echo=FALSE, results='asis', eval=is_csv&isProvided(params$path_software_versions)}
