...
## Load Rsem count table
    if (params$input_type == "rsem") {
        ...
        if (!(all(file.exists(files)))) {
            stop("DESeq2.R could not find all of the specified .genes.results files! Please check that for all QBiC codes in the metadata sheet, a quant.sf file is present in the gene_counts folder and make sure that no typos exist.")
        }
...
# Load salmon count files
        ...
        if (!(all(file.exists(files)))) {
            stop("DESeq2.R could not find all of the specified quant.sf files! Please check that for all QBiC codes in the metadata sheet, a subfolder with a quant.sf file is present in the gene_counts folder and make sure that no typos exist.")
        }
