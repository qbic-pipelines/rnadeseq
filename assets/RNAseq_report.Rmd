...
```{r PCA_ifNoBatch_plot, echo=F, message=F, warning=F, fig.width=1, fig.heigth=1.5, dpi=1200, fig.align='center'}
############################ PCA PLOTS ########################
...
```{r PCA_ifBatch_plot, echo=F, message=F, warning=F, fig.width=1, fig.heigth=1.5, dpi=1200, fig.align='center', eval=params$batch_effect}
