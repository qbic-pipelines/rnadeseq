...
The raw count table can be found [here](./DESeq2/gene_counts_tables/raw_gene_counts.txt). The normalized count tables are available [here](./DESeq2/gene_counts_tables): rlog_transformed_gene_counts.tsv and vst_transformed_gene_counts.tsv.
