...
if (params$input_type %in% c("featurecounts", "smrnaseq")) {
    ...
    write("rsem1", file="/home-link/iivow01/git/rnadeseq/error/status", append=F)
...
## Load Rsem count files
    ...
    write("rsem2", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
    ...
    write("rsem3", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
...
if (isProvided(params$path_relevel)) {
        write("rsem4", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
    ...
    for (i in c(1:nrow(relevel_table))) {
        ...
        write("rsem5", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
...
if (params$input_type %in% c("featurecounts", "smrnaseq")) {
    ...
    write("rsem6", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
...
if (run_rlog){
    ...
    write("rsem7", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
...
meanSdPlot(assay((if (run_rlog) rld else vsd)[notAllZero,]),ylab  = paste("sd", norm_method_text, "transformed count data"))
dev.off()
    write("rsem8", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
...
for (i in resultsNames(cds)[-1]) {
    ...
    write("rsem9", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
...
knitr::include_graphics(paste0(wd, "/QC/multiqc_plots/svg/mqc_star_alignment_plot_1_pc.svg"), error=F)
    write("rsem10", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
...
if (run_rlog) {
    ...
    write("rsem11", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
...
if (isProvided(params$path_contrast_list)) {
    ...
    write("rsem12", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
...
if (!isProvided(params$path_contrast_matrix) & !isProvided(params$path_contrast_list) & !isProvided(params$path_contrast_pairs)) {
    ...
    write("rsem13", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
...
log2FoldChange_max <- max(DE_all$log2FoldChange)
    write("rsem14", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
...
for (i in nrow(random_DE_genes_plot)) {
    ...
    write("rsem15", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
...
if (isProvided(params$datasources)) {
    ...
    write("rsem16", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
...
write("rsem17", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
...
if (mv_status) {
    ...
    write("rsem17.1", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
...
# For each contrast do pathway analysis
    write("rsem17.2", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
...
for (file in contrast_files){
    ...
    write("rsem17.3", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
    ...
    write("rsem17.4", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
    ...
    write("rsem17.5", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
    ...
    write("rsem17.6", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
    ...
    write("rsem18", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
...
if (isProvided(params$path_genelist)){
    ...
    mat$Ensembl_ID <- NULL
    mat <- data.matrix(mat)
    write("rsem19", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
...
```{r software_versions_RNASeq, echo=FALSE, results='asis', eval=isProvided(params$path_software_versions)}
    write("rsem20", file="/home-link/iivow01/git/rnadeseq/error/status", append=T)
