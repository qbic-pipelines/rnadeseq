...
if (isProvided(params$custom_gmt)){
    ...
    database_string = paste0("Also, the following databases were queried: ", gpro_version_string)
    capture.output(database_string, file="/home-link/iivow01/git/rnadeseq/error/db1")
    ...
    for (db in datasources) {
        ...
        capture.output(database_string, paste0(file="/home-link/iivow01/git/rnadeseq/error/db2_after_", db))

    }
    database_string <- strsplit(database_string, ",\\s*(?=[^,]+$)", perl=TRUE)[1]
    capture.output(database_string, file="/home-link/iivow01/git/rnadeseq/error/db3")
