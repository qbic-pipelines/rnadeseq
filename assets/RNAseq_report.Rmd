...
capture.output(!isNot(params$batch_effect), file="/mnt/volume/git/rnadeseq/bug/status", append=T)
if(!isNot(params$batch_effect)){
    ...
    percentVar <- round(100*attr(pcaData, "percentVar"))
    write("running pca2", file="/mnt/volume/git/rnadeseq/bug/status", append=T)
    pca2 <- ggplot(pcaData2, aes(PC1, PC2, color=combfactor)) +
                ...
                theme(legend.title = element_blank()) +
                coord_fixed()
    capture.output(pca2, file="/mnt/volume/git/rnadeseq/bug/pca2")
