...
if (!inherits(df_gene, 'no lines available in input')){
  names = rownames(df_gene)
  gene = TRUE
}
```

```{r contrasts_block, echo=FALSE, results='asis', eval=gene}
cat("***
Plots for the [genes of interest](./DESeq2/metadata/gene_list.txt) can be found [here](./DESeq2/plots/boxplots_requested_genes/).
\
")
```
