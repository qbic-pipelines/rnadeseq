...
quote_string <- ifelse(
    ...
    paste0("The results for all work packages, as described in the [quote](", params$path_quote, "), can be found in this report."),
    paste0("The results for all work packages, as described in the quote, can be found in this report.")
)
cat(quote_string)
```
