...
species_dir <- tempdir()
install.packages('viridis', lib=species_dir,repos = "http://cran.us.r-project.org")
library("viridis", lib.loc=species_dir)

install.packages('heatmaply', lib=species_dir,repos = "http://cran.us.r-project.org")
library("heatmaply", lib.loc=species_dir)
...
```{r PCA_ifNoBatch_plot, warning=F, echo=F, message=F, out.width="100%", out.height="100%", dpi=1200, fig.align='center'}
...
```{r PCA_ifBatch_plot, warning=F, echo=F, message=F, out.width="100%", out.height="100%", dpi=1200, fig.align='center', eval=params$batch_effect}
...
```{r heatmap, echo=FALSE, message=FALSE, warning=FALSE, out.width="90%", out.height="130%", fig.asp=1, dpi=1000, fig.align='center'}
...
par(oma=c(3,3,3,3))
dist_heatmap <- heatmaply(sampleDistMatrix, dendrogram = "both", col=colors, file=c("differential_gene_expression/plots/Heatmaps_of_distances.pdf", "differential_gene_expression/plots/Heatmaps_of_distances.png", "/home-link/iivow01/git/rnadeseq/error/plot.png"), grid_color = "grey")
dist_heatmap
```
