...
if (!(isNot(params$path_contrast_matrix))){
    ...
    for (i in c(1:ncol(contrasts))) {
        ...
        DE_genes_contrast <- subset(DE_genes_contrast_genename, padj < 0.05 & abs(log2FoldChange) > params$logFC_threshold)
...
log_FC_text <- as.character(params$logFC_threshold)
```
...
```{r volcano_plot, out.width="100%", out.height="100%"}
    ...
    log_FC_num <- as.numeric(params$logFC_threshold)
