...
for (file in allgenes_files){
    ...
    pg <- ggplot(
            ...
            geom_point(
            alpha = 0.5, aes(colour = ifelse(color == "red", "DE",
                ifelse(color == "blue", paste0("padj<=", params$adj_pval_threshold),
                ifelse(color == "green", paste0("log2FC>|", params$logFC_threshold, "|"),
                    ifelse(color == "black", "Non-DE", "")
                )
                )
            )),
            na.rm = TRUE
            ...
            ggtitle(
                ...
                subtitle=paste0("total=", thousandFormat(nrow(DE_genes)), ", DE=", thousandFormat(numDE)))
