...
capture.output(metadata, file="/home/iivow01/git/rnadeseq/error/met1")
...
capture.output(metadata, file="/home/iivow01/git/rnadeseq/error/met2")
...
if (params$input_type == "featurecounts"){
    ...
    error_out <- write_error_msg(count.table, metadata)
    options(warning.length = 2000L) #increase length of error messages
    #stop(paste0(error_out, "\n"), call.=F)
    }
