...
#if (nchar(title) > 65 & nchar(title) < 130) {
  #title1 = paste(substr(title, 1, 65), substr(title, 66, nchar(title)),sep= "\n")
  #title1 = substr(title, 1, 65)
  #title2 = substr(title, 66, nchar(title))
#} else if (nchar(title) > 130) {
  #title = paste(substr(title, 1, 65), substr(title, 66, 130), substr(title, 131, nchar(title)),sep= "\n")
  #title1 = substr(title, 1, 65)
  #title2 = substr(title, 66, 130)
  #title3 = substr(title, 131, nchar(title))
#} else {
#  title1 = title
#}
title1 = substr(title, 1, 65)
...
subtitle: "`r paste(title1, title2, title3, sep= " <br> ")`"
