...
# Set the title; if the title is too long, it would get covered by the logo, so it is splitted in 2 or 3 parts.
title = as.character(df$Short.Title)
if (nchar(title) > 65 & nchar(title) < 130) {
  title = paste(substr(title, 1, 65), substr(title, 66, nchar(title)),sep= "\n")
