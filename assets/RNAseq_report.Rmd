...
```{r heatmap, echo=FALSE, message=FALSE, warning=FALSE, out.width="100%", out.height="100%", fig.asp=1, dpi=1000, fig.align='center'}
...
par(oma=c(3,3,3,3))
dist_heatmap <- heatmaply(sampleDistMatrix, dendrogram = "both", col=colors, file="differential_gene_expression/plots/Heatmaps_of_distances.pdf", grid_color = "grey")
#dist_heatmap <- heatmaply(sampleDistMatrix, dendrogram = "both", col=colors, file="differential_gene_expression/plots/Heatmaps_of_distances.svg", grid_color = "grey")
dist_heatmap <- heatmaply(sampleDistMatrix, dendrogram = "both", col=colors, file="differential_gene_expression/plots/Heatmaps_of_distances.png", grid_color = "grey")
dist_heatmap <- heatmaply(sampleDistMatrix, dendrogram = "both", col=colors, height=height*1.2, grid_color = "grey")
dist_heatmap
```
