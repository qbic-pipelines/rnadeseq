...
```{r, out.width="100%", out.height="100%"}
    ...
    #limits = c(floor(log2FoldChange_min), ceiling(log2FoldChange_max)), breaks = c(floor(log2FoldChange_min):ceiling(log2FoldChange_max))
    ...
    pg <- ggplot(DE_all, aes(x=log2FoldChange, y=logpval, text=paste("Gene: ", gene_name, "<br>", "Log2FC: ", formatC(log2FoldChange, digits=2)))) +
         ...
         #   annotate(geom = "text", x = 0, y = 16.3, label = "values above this threshold are capped\t\tvalues above this threshold are capped\t\tvalues above this threshold are capped", size = 3, color = "grey")
