...
if (file.exists(paste0(wd,"/QC/multiqc_data/multiqc_general_stats.txt"))) {
    ...
    mqc_version <- 'old_mqc'
} else if (file.exists(paste0(wd,"/QC/multiqc_data/multiqc_samtools_flagstat.txt"))) {
    df_DE <- read.table(file = paste0(wd,"/QC/multiqc_data/multiqc_samtools_flagstat.txt"), header=TRUE, sep="\t")
    mqc_version <- 'old_mqc'
} else {
    stop("Could not find a suitable multiqc table; please provide a correct multiqc.zip file or omit the parameter altogether")
}
capture.output(colnames(df_DE), file="/sfs/9/ws/iivow01-test/rnadeseq/error/colnames")
...
write.table(table_complete, file="/sfs/9/ws/iivow01-test/rnadeseq/error/table_complete1", sep="\t", quote=F)
...
if (mqc_version == 'old_mqc') {
    ...
    write.table(table_complete, file="/sfs/9/ws/iivow01-test/rnadeseq/error/table_complete2", sep="\t", quote=F)
}
write.table(table_complete, file="/sfs/9/ws/iivow01-test/rnadeseq/error/table_complete3", sep="\t", quote=F)
capture.output(colnames, file="/sfs/9/ws/iivow01-test/rnadeseq/error/colnames")
