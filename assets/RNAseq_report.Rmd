...
For PCA analysis and heatmap plotting, the variance stabilized transformed (vst) gene counts were employed.
The regularized logarithm transformed (rlog) gene counts are also provided.
