...
cat("***
# Sample metadata
The sample information is summarized in the table below and can be found [here](./DESeq2/metadata/Sample_preparations.tsv).
\
")
