...
```{r aligner_strings, echo=FALSE, message=FALSE, warning=FALSE}

# Change the different strings depending on which input_type was used
...
for (file in contrast_files){
    ...
    if (params$background_list) {
        gostres <- gost(query=q,
            ...
            custom_bg=rownames(counts(cds))[notAllZero],
