...
if (isNot(params$path_contrast_matrix) & isNot(params$path_contrast_list) & isNot(params$path_contrast_pairs)) {
    capture.output(coefficients, file="/mnt/volume/git/rnadeseq/bug/coeff")
    contrast_names <- coefficients[2:length(coefficients)]
    capture.output(contrast_names, file="/mnt/volume/git/rnadeseq/bug/cont1")
...
capture.output(contrast_names, file="/mnt/volume/git/rnadeseq/bug/contrast_names2.txt")
