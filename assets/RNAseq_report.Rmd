...
datatable(df_QA, caption = "Quality Assessment", colnames = sub(".", " ", names(df_QA)), extensions = c('Buttons', 'FixedColumns'), "Autofill", options = list(dom = 'Bfrtip', scrollX = T, scrollCollapse = T, buttons = c('copy', 'csv', 'excel', 'pdf', 'print')))
```
...
datatable(df_QA, caption = "Sample metadata", colnames = sub(".", " ", names(df_QA)), extensions = c('Buttons', 'FixedColumns'), "Autofill", options = list(dom = 'Bfrtip', scrollX = T, scrollCollapse = T, buttons = c('copy', 'csv', 'excel', 'pdf', 'print')))
```
