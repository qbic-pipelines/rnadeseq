...
The primary bioinformatics analysis was performed using the [nf-core/rnaseq](https://nf-co.re/rnaseq) pipeline, version ",
...
The primary bioinformatics analysis was performed using the pipeline [nf-core/smrnaseq](https://nf-co.re/smrnaseq), version ",
...
[FASTQC v", as.character(ifelse(software_versions_csv, version["FastQC"], version["FASTQC"][[1]]["fastqc"])),
...
Subsequently, adapter trimming was conducted with [Trim Galore v",
...
The RNA-seq data quality control was performed with [RSeQC v",
...
[FASTQC v", as.character(version["FASTQC"][[1]]["fastqc"]),
...
ifelse("TRIMGALORE" %in% names(version), paste0("Subsequently, adapter trimming was conducted with [Trim Galore v",
as.character(version["TRIMGALORE"][[1]]["trimgalore"]),
"](https://www.bioinformatics.babraham.ac.uk/projects/trim_galore/) [@krueger2012trim]."),
    ifelse("FASTP" %in% names(version), paste0("Subsequently, adapter trimming was conducted with [fastP v",
...
The smRNA-seq data quality control was performed with [miRTrace v",
...
The secondary analysis of differential gene expression was performed by the using the [rnadeseq pipeline](https://github.com/qbic-pipelines/rnadeseq), version ",
