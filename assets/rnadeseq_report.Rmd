...
<details>
<summary>**Design strategie**</summary>
...
<br>
Click to expand/uncollapse the detailss<br>
<details>
...
Please hover over the dots to display the pathway names. The table below provides more detail on all enriched terms."))
```
...
```{r quote, echo=FALSE, results='asis', include=F, eval=F}
...
quote_string <- ifelse(
    ...
    paste0("For further analysis (e.g. the re-analysis of the dataset) we will generate a new quote containing cost estimates.")
)
cat(quote_string)
