process REPORT {
    ...
    def pathway_pval_threshold_opt = params.pathway_pval_threshold == -1 ? "--pathway_pval_threshold $params.adj_pval_threshold" : "--pathway_pval_threshold $params.pathway_pval_threshold"
